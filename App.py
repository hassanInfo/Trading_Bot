...
st.markdown('<h2 align="center">We are here to provide you the best Market order </h1>', unsafe_allow_html=True)
st.markdown('<h2 align="center"></h1>', unsafe_allow_html=True)
option = st.selectbox(
    'Please select a currency or a stock:',
